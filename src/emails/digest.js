...
const messageLength = config.get("email_settings.message_length") || 30;

roomNameMap = {
  '_nashi-novosti': 'Наши новости',
  '_pro-it' : 'PRO.IT',
  '_learn-ocs': 'Learn.OCS',
  'klub-o': 'Клуб О'
}

module.exports.digestEmail = (data) => {
  const payload = data.map((room) => {
    const roomMessages = room.messages
      .map((message) => {
        let msg = '';
        if(message.msg){
          if(message.msg.split(' ').length > messageLength) {
            msg = message.msg.split(' ').slice(0, messageLength).join(' ');
          } else {
            msg = `${message.msg}`;
          }
        } else if(message.attachments[0].description) {
        ...
        return `
          <tr style="border-collapse:collapse"> 
            <td align="left" style="padding:0;Margin:0"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:24px;color:#333333"><em>Автор</em>: <em><u>${message.u.name}</u></em></p></td> 
          </tr> 
          <tr style="border-collapse:collapse"> 
            <td class="es-m-txt-c" align="left" style="padding:0;Margin:0;padding-bottom:10px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:14px;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333">${msg}<a href=\`${baseUrl}/channel/${room.name}?msg=${message._id}\`><em>...читать</em></a></p></td> 
          </tr>`;
      })
      .join('');
    ...
    return `
      <tr style="border-collapse:collapse"> 
        <td class="es-m-txt-c" align="center" style="padding:0;Margin:0;padding-bottom:10px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:20px;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:40px;color:#333333"><span style="color:#2F4F4F">Канал </span> <span style="color:#FFA500">${roomNameMap[room.name]}:</span><i class="fab fa-rocketchat" style="font-size:30px;color:yellow;background-color:black" ></i></p></td> 
      </tr>
      ${roomMessages} 
      `;
  }).join('');
                 ...
                 <tr style="border-collapse:collapse"> 
                  <td valign="top" align="center" style="padding:0;Margin:0;width:560px"> 
                   <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                    <tr style="border-collapse:collapse"> 
                      <td align="center" style="padding:0;Margin:0;padding-bottom:5px"><h2 style="Margin:0;line-height:31px;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-size:26px;font-style:normal;font-weight:normal;color:#333333">Новости корпоративных каналов Rocket <img src="cid:logo" width="25" height="25" alt="rocket" style="margin-bottom:-5px" ></h2></td> 
                    </tr> 
                    ${payload}
                    <tr style="border-collapse:collapse"> 
                      <td align="left" style="padding:0;Margin:0"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:24px;color:#333333"><a href="https://support.ocs.ru/sd/operator/?anchor=add:serviceCall$accessCall::accessCall:accessObj=accessAD$33655901,agreement=agreement$4660001,service=slmService$29855002">Отписаться можно через заявку в Help Desk</a></p></td> 
                    </tr>
                   </table></td> 
                 </tr> 
               </table></td> 
